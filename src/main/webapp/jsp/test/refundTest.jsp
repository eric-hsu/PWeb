...
<html>
  ...
  <body>
		...
		<div class="row">
			<div class="span12">
				 <form  id="orderForm" action="${ctx}/payment/refundRequest.do" method="post">
				    <fieldset>
				    <div id="legend" class="">
				        <legend class="">订单退款</legend>
				      </div>
				    <br>
				      <div class="control-group">
				          ...
				          <div class="controls">
				            ...
				            <p class="help-block" style="margin-top:10px;">平台交易流水，支付平台产生的流水号.</p>
				          </div>
				         ...
				         <div class="control-group">
				          ...
				          <div class="controls">
				            <input type="text" value="10000" class="required" name="merNo"/>
				     ...
				     <div class="control-group">
				          ...
				          <div class="controls">
				            <input type="text" value="10000001" class="required" name="gatewayNo"/>
				    ...
				    <div class="control-group" >
				          ...
				          <!-- Text input-->
				          <label class="control-label" for="input01" >退款金额：</label>
				          <div class="controls">
				            <input type="text"   value="" class="required" name="refundAmount"/>
				            <p class="help-block" style="margin-top:10px;">需要退款金额.</p>
				          </div>
				        </div>
				      ...
				      <div class="control-group" >
				          ...
				          <div class="controls">
				            ...
				            <p class="help-block" style="margin-top:10px;">默认CNY，人民币</p>
				          </div>
				        </div>
