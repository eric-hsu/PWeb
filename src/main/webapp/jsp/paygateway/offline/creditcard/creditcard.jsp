	...
	<script type="text/javascript" src="${ctx}/js/jquery-1.9.1.min.js"></script>
  	...
  	<body >
		...
		<div class="container">
			<div class="row">
				<div class="span12">
					<form class="form-horizontal" id="paymentForm"  action="${ctx}/creditcardController/quickPay.do" method="post">
					    <fieldset>
					      <div id="legend" class="">
					        <legend class="">信用卡快捷支付信息 <a href="javascript:history.go(-1);" style="float:right; font-size: 14px;">重新选择支付方式</a></legend>
					    ...
					    <div class="control-group">
					          ...
					          <!-- Text input-->
					          <label class="control-label" for="input01">信用卡卡号</label>
					          <div class="controls">
					          ...
					          <div class="controls">
					            <select class="input-xlarge" style=" width: 130px;">
							      <option>2014</option>
							      <option>2015</option>
							      <option>2016</option>
							      <option>2017!</option>
					          ...
					          <div class="controls">
					            ...
					            <p class="help-block" style="margin-top:10px;">注：信用卡注册手机号码</p>
					          </div>
					        </div>
					    ...
					    <div class="control-group">
							...
							<div class="control-group">
					          ...
					          <div class="controls">
					            ...
					            <button class="button button-pill button-primary" type="submit">提交</button>
					          </div>
					        </div>
