 ...
 */
@Entity
@Table(name = "CCPS_INFORMAL_TRADERECORD")
public class InformalTraderecord implements java.io.Serializable {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CCPS_INFORMAL_TRADERECORD_SEQ")
	@SequenceGenerator(name = "CCPS_INFORMAL_TRADERECORD_SEQ", allocationSize = 1, initialValue = 1, sequenceName = "CCPS_INFORMAL_TRADERECORD_SEQ")
	private Long ttrId;
...
//	private String ttrBankdatetime;
	...
	// 商户页面返回地址
	@Column(name = "TTR_PAGE_RETURNURL")
	private String ttrPageReturnurl;
	...
	public String getTtrPageReturnurl() {
		return ttrPageReturnurl;
	}

	public void setTtrPageReturnurl(String ttrPageReturnurl) {
		this.ttrPageReturnurl = ttrPageReturnurl;
	}

	@Override
	public String toString() {
		return "InformalTraderecord [ttrNo=" + ttrNo + ", ttrDatetime="
				+ ttrDatetime + ", ttrMerNo=" + ttrMerNo + ", ttrGwNo="
				+ ttrGwNo + ", ttrMerOrderno=" + ttrMerOrderno
				+ ", ttrCurrency=" + ttrCurrency + ", ttrAmount=" + ttrAmount
				+ ", ttrStatus=" + ttrStatus + ", ttrBankCode=" + ttrBankCode
				+ "]";
	}
}