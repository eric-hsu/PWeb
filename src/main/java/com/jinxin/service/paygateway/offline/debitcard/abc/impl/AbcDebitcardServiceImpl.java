package com.jinxin.service.paygateway.offline.debitcard.abc.impl;
 ...
 */
@Service("abcDebitcardService")
@Scope("prototype")
public class AbcDebitcardServiceImpl implements OfflinePayGatewayProxy{
