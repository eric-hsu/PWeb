...
public class XMLDocument {
    ...
    public static void main(String[] argc) {
        ...
        //XMLDocument tXMLDocument = new XMLDocument("<Message><ECMerchantType>B2C</ECMerchantType><ECMerchantType>B2C</ECMerchantType></Message>");
        System.out.println("Formated\n" + tXMLDocument.getFormatDocument("    ").toString());
        System.out.println(tXMLDocument.deleteFirstTagDocument());
    }
}
