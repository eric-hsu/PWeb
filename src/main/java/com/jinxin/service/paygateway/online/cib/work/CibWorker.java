package com.jinxin.service.paygateway.online.cib.work;
 ...
 */
@Component
public class CibWorker  implements OnlineWorker{
    private static final Logger logger = Logger.getLogger(CibWorker.class);
    // 1秒等于1000毫秒的单位
    ...
    public String send(Map<String, String> params, OlineSendDataBean sendBean) {
        ...
        if (sendBean instanceof CibSendBean) {
        	cibSendBean = (CibSendBean) sendBean;
        } else {
