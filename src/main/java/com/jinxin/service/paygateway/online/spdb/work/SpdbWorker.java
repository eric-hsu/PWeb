package com.jinxin.service.paygateway.online.spdb.work;
 ...
 */
@Component
public class SpdbWorker  implements OnlineWorker{
    private static final Logger logger = Logger.getLogger(SpdbWorker.class);
    // 1秒等于1000毫秒的单位
    ...
    public String send(Map<String, String> params, OlineSendDataBean sendBean) {
    	SpdbSendBean spdbSendBean = null;

        // 把sendBean转换成ISpdbSendBean
        if (sendBean instanceof SpdbSendBean) {
        	spdbSendBean = (SpdbSendBean) sendBean;
        } else {
